...
export const Route = createLazyFileRoute('/user/')({
  component: () => (
    <div>
      <h1 className="text-2xl font-semibold text-secondary mt-12 mb-8">Profile for userX</h1>
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-side">
          ...
          <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4">
            ...
            <li><a>NFTs Earned</a></li>
            <li><a>Submission Statuses</a></li>
            <li><a>Workshops Attended</a></li>

const Footer = () => {
  return (
    <footer className="footer gap-y-0 footer-center bg-base-200 text-base-content rounded p-4 mx-auto max-w-[85vw] absolute bottom-0 left-[50%] translate-x-[-50%] shadow-[0_-5px_30px_-15px_var(--tw-shadow-color)] shadow-secondary">

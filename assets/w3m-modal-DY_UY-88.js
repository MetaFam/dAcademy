import{dk as c,ef as k,fb as le,dq as pe,cY as v,cZ as V,d0 as f,d1 as g,d2 as d,c$ as l,dO as $,dp as H,dP as u,c_ as me,de as w,d4 as B,dM as U,eZ as fe,el as F,dr as K,e9 as A,dh as M,d7 as we,dj as E,eh as z,eW as oe,dN as be,d6 as ce,fc as ge,fd as ye}from"./index-CkghpzNC.js";import{P as D}from"./index-mPISwcRW.js";import{S as ve}from"./SwapController-CmIG_lph.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
...
`;var Z=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let T=class extends g{constructor(){super(...arguments),this.message="",this.variant="success"}render(){return d`
    ...
    `}templateIcon(){const t={success:"success",error:"error",warning:"warning",info:"default"},i={success:"checkmark",error:"warning",warning:"warningCircle",info:"info"};return this.variant==="loading"?d`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:d`<wui-icon-box
      ...
      icon=${i[this.variant]}
    ></wui-icon-box>`}};T.styles=[V,_e];Z([l()],T.prototype,"message",void 0);Z([l()],T.prototype,"variant",void 0);T=Z([f("wui-snackbar")],T);const Te=we`
  :host {
    display: block;
    position: absolute;
    opacity: 0;

import{bd as O,r as v,be as P,bf as W,bg as $,bh as k}from"./index-nBQDF0U9.js";const V="2.13.0",A=()=>`wagmi@${V}`;class q extends O{constructor(){super(...arguments),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"WagmiError"})}get docsBaseUrl(){return"https://wagmi.sh/react"}get version(){return A()}}class C extends q{constructor(){super("`useConfig` must be used within `WagmiProvider`.",{docsPath:"/api/WagmiProvider"}),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"WagmiProviderNotFoundError"})}}function _(e={}){const r=e.config??v.useContext(P);if(!r)throw new C;return r}var E={exports:{}},w={},b={exports:{}},j={};/**
 * @license React

import{cG as e,dB as u,cE as x}from"./index-CkghpzNC.js";import{M as p,u as j}from"./index-BP6_U-eU.js";import{a as g}from"./index-DrLaus3h.js";import{g as f,r as b}from"./gql-DHmsBT2a.js";import"./index-ItR96vxd.js";import"./useConfig-C_cL0Luq.js";globalThis.jotaiAtomCache=globalThis.jotaiAtomCache||{cache:new Map,get(s,c){return this.cache.has(s)?this.cache.get(s):(this.cache.set(s,c),c)}};function h({name:s,cover:c,description:i,className:t=""}){return e.jsxs("figure",{className:`relative w-fit ${t}`,children:[e.jsx("img",{src:u(c),className:"max-h-60 relative"}),e.jsxs("figcaption",{className:"absolute inset-0 flex flex-col justify-center items-center z-20 text-xl font-bold",children:[e.jsx("h2",{className:"text-center bg-white/30 text-white px-2 py-1 rounded-md",children:s}),e.jsx("section",{className:"description",children:e.jsx(p,{children:i})})]})]})}globalThis.jotaiAtomCache=globalThis.jotaiAtomCache||{cache:new Map,get(s,c){return this.cache.has(s)?this.cache.get(s):(this.cache.set(s,c),c)}};const y=f`
